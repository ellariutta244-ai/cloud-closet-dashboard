...
export async function GET(request: Request) {
  ...
  if (code) {
    ...
    if (!error) {
      return NextResponse.redirect('https://cloud-closet-dashboard.vercel.app/dashboard')
    }
  }

  return NextResponse.redirect('https://cloud-closet-dashboard.vercel.app/auth?error=confirmation_failed')
}
